...
import slide1 from "../images/logo.png"
function Header() {
    ...
    return (
            <div className="row jumbotron p-2 mb-0 rounded-0 text-white" style={{ background: "#6C4AB6" }}>
                <div className="col ">
                    <img  src={"https://tukuz.com/wp-content/uploads/2023/03/pharmeasy-logo-vector.png"} alt={"icon"} style={{ width: "120px", height: "90px" }} className="float-left"/>
                </div>
                <div className="col">
